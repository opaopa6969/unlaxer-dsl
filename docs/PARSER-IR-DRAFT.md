...
- `invalid-*.json`: negative fixtures for required keys / span order / code format / invalid scope event / scope order violation / duplicate scope enter / unknown targetScopeId / broken related diagnostics / unknown parentId / unbalanced scopes / diagnostic span out-of-range.
